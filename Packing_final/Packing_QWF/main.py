...
if __name__ == '__main__':
	...
	f = open("time.txt", "a")
	f.write("      %d &       %f\n" %(num_forno,round((time.time() - start_time),1)))
	f.close()
	
	print(sys.argv[1],"forno", num_forno," com ", num_nivel1, " niveis", "dividimos em" , aux, " e o tempo de execucao eh ",round((time.time() - start_time),1),"\n")
